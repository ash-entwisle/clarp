...
assert(
  p.options['option1'] !== undefined && p.options['option1'] !== null,
  'option1 does not contain data',
);
assert(
  p.options['option2'] !== undefined && p.options['option2'] !== null,
  'option2 does not contain data',
);
assert(
  p.options['option3'] === undefined,
  'option3 contains data but it should not exist',
);
...
assert(
  p.raw.length === 11,
  `Expected raw args length to be 11, but got ${p.raw.length}`,
);
